...
-- 6. Create network rule and EAI for Streamlit apps (requires ACCOUNTADMIN)
...
-- 7. Create a compute pool for Session 6 (Streamlit app)
CREATE COMPUTE POOL IF NOT EXISTS HIIVE_COCO_HOL_COMPUTE_POOL
  MIN_NODES = 1
  MAX_NODES = 1
  INSTANCE_FAMILY = CPU_X64_S;

-- 8. Enable cross-region inference (requires ACCOUNTADMIN)
